...
- **헬스케어 데이터 플랫폼 백엔드 개발** (2025.07 ~ 현재)
  - 사용자·기업 관리자·내부 관리자용 API와 건강 데이터 처리 기능 개발
- **장례식장 상담 시스템 백엔드 개발 및 배포** (2026.07 ~ 2026.08)
  - Cloudflare Workers 기반 API 구축, DB 설계 및 배포 환경 구성
- **Yobi(요비) — 디지털 돌봄 기록 솔루션 개발** (2025.04 ~ 2025.05)
  - Android 기반 건강 대시보드·돌봄 일지·주간 리포트 기능 및 API 연동 구현
- **SSAcle(싸클) — 스터디 관리 통합 앱 개발** (2025.01 ~ 2025.02)
  - Android 및 AI 기능 구현, 자기소개서 첨삭·면접 표정/시선 피드백 기능 개발

### 🏆 수상

- **2026 KHF 혁신상 (대한병원협회장상)**
  - 헬스케어 프로젝트의 PPG 기반 생체신호 모델 QA와 개인화 학습·실시간 예측 플로우 설계 및 구현
